...
class BuilderTableCreateDigartEnseignementElevesHistoriques extends Migration
{
    public function up()
    {
        Schema::create('digart_ecole_eleves_historiques', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('digart_ecole_eleves_historiques');
    }
}