...
class BuilderTableCreateDigartEnseignementEnseignants extends Migration
{
    public function up()
    {
        Schema::create('digart_ecole_enseignants', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('digart_ecole_enseignants');
    }
}