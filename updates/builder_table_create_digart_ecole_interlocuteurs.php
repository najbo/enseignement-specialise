...
class BuilderTableCreateDigartEnseignementInterlocuteurs extends Migration
{
    public function up()
    {
        Schema::create('digart_ecole_interlocuteurs', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('digart_ecole_interlocuteurs');
    }
}