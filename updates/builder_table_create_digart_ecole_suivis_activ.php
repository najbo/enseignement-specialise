...
class BuilderTableCreateDigartEcoleSuivisActiv extends Migration
{
    public function up()
    {
        Schema::create('digart_ecole_suivis_activ', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('digart_ecole_suivis_activ');
    }
}