...
class BuilderTableCreateDigartEnseignementEleves extends Migration
{
    public function up()
    {
        Schema::create('digart_ecole_eleves', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('digart_ecole_eleves');
    }
}